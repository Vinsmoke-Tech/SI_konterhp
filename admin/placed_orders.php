...
<section class="placed-orders">
   ...
   <h1 class="heading">placed orders</h1>
    <a class="btn-lap" href="report.php"><i class="fa fa-print"></i> Laporan</a>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <option value="<?= $fetch_orders['payment_status']; ?>"><?= $fetch_orders['payment_status']; ?></option>
            <option value="belum bayar">belum bayar</option>
            <option value="COD">COD</option>
            <option value="lunas">lunas</option>
         </select>
         <select name="order_status" class="drop-down">
         <option value="<?= $fetch_orders['order_status']; ?>"><?= $fetch_orders['order_status']; ?></option>
